...
function build_firmware(){
    ...
    svn co https://github.com/kenzok8/openwrt-packages/trunk/luci-app-smartdns custom/luci-app-smartdns
    svn co https://github.com/kenzok8/openwrt-packages/trunk/smartdns custom/smartdns
